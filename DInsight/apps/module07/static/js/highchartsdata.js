function draw(itemid) {
        ...
        $('#container').highcharts({
            ...
            title: {
                text: 'Topic popularity 2013 through 2014'
            },
            subtitle: {
            ...
            series: [{
                ...
                data: [
                    ...
                    0.7618, 0.7615, 0.7612, 0.7596, 0.758
                ]
            },
			{
                type: 'area',
                name: 'period2',
                pointInterval: 24 * 3600 * 1000,
                pointStart: Date.UTC(2013, 11, 31),
				fillColor: '#eab064',
                data: [
					0.758, 0.758, 0.7547, 0.7549, 0.7613,
            ...
            },
            {
                ...
                name: 'period3',
                pointInterval: 24 * 3600 * 1000,
                pointStart: Date.UTC(2014, 11, 30),
                fillColor: '#BBBEE1',
                data: [
